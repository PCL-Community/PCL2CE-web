...
const getIconPath = (icon: string) => icons[icon as keyof typeof icons] || icons.github
const isStrokeIcon = (icon: string) => icon === 'users'
</script>
    ...
    >
      <div class="link-card-icon">
        <svg
          ...
          height="24"
          viewBox="0 0 24 24"
          :fill="isStrokeIcon(item.icon) ? 'none' : 'currentColor'"
          :stroke="isStrokeIcon(item.icon) ? 'currentColor' : undefined"
          :stroke-width="isStrokeIcon(item.icon) ? 2 : undefined"
